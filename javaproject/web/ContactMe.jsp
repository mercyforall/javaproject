<%-- 
    Document   : ContactMe
    Created on : May 4, 2017, 11:18:00 AM
    Author     : Freeware Sys
--%>
    ...
    <div>
     <body bgcolor="lightgreen">
         ...
         <table align='center' >
              ...
              <tr><td>BRANCH*:</td><td><input type="text" name="t2" id="t2"></td></tr>
              <tr><td>MOBILE NO*:</td><td><input type="text" name="t3" id="t3"></td></tr>
              <tr><td>DEPARTMENT*:</td><td><input type="text" name="t4" id="t4"></td></tr>
              <tr><td>COURSE*:</td><td><input type="checkbox" name="t5" id="t5">Gate</td>
                  <td><input type="checkbox" name="t5" id="t5">IES</td><tr>
              <tr><td>EMAIL*:</td><td><input type="text" name="t6" id="t6"></td></tr>
              <tr><td>MESSAGE*:</td><td><input type="textarea" name="t7" id="t7"></td></tr>
